...
import { getDatings } from "../../../../api/dating.methods"
...
function UsersList({ openSwipes, openGoldPlan }: { openSwipes: (e: number) => void }) {
    const { data: dating, refetch, isRefetching } = useQuery(QueryKey.datings, getDatings)
            ...
            /> : (
                <View style={styles.noMatches}>
                    <Text style={styles.noMatchesTitle}>
                        You need to Check in to an event to see users here
                    </Text>
                </View>
            )}
        </ScrollView>
